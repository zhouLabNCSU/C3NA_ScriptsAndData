...
### 2.1 Main Figure 2A
```{r}
githubURL <- ("https://github.com/zhouLabNCSU/C3NA_ScriptsAndData/raw/main/SupplementaryPlotData/MainFA.rdata")
baxterDADA2Cancer <- load(url(githubURL, method="libcurl"))
png(filename = paste0("../MainFig2A.png"),
