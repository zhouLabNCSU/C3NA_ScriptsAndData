...
```{r}
githubURL <- ("https://github.com/zhouLabNCSU/C3NA_ScriptsAndData/raw/main/SupplementaryPlotData/MainF1A.rdata")
...
### 2.1 Main Figure 2B
```{r}
githubURL <- ("https://github.com/zhouLabNCSU/C3NA_ScriptsAndData/raw/main/SupplementaryPlotData/MainF1B.rdata")
load(url(githubURL, method="libcurl"))
